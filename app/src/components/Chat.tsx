...
export default function Chat() {
  ...
  // estado del avatar
  const [avatarState, setAvatarState] = useState<'standby' | 'talking' | 'thinking'>('standby')
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex flex-1 flex-col">
            {/* Header */}
            <div className="flex items-center justify-between border-b px-4 py-4 text-white shadow-md" style={{ backgroundColor: '#6e348d', height: '96px' }}>
              <div className="flex items-center gap-2">
                ...
                {/* Avatar mini */}
                <div className="flex items-center justify-center rounded-full bg-white/10 shadow-sm flex-shrink-0"
                    style={{ width: 80, height: 48 }}>
                  {/* lo escalamos para que quepa en el header */}
                  <Avatar state={avatarState} className="scale-[0.23] origin-center" />
                </div>
                ...
                <div className="flex-shrink-0">
                  ...
                  <p className="text-xs text-white/90 whitespace-nowrap">
                    {avatarState === 'thinking' ? 'Pensando…' : avatarState === 'talking' ? 'Hablando…' : 'En línea'}
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="border-t bg-white p-4">
              <div className="flex gap-2">
                <textarea
                  ref={inputRef}
                  value={inputValue}
                  onChange={(e) => { setInputValue(e.target.value); setAvatarState('thinking'); }}
