...
// Datos de ejemplo (mock) para desarrollo local.
// NOTA: solo para desarrollo/demo. NUNCA usar contraseñas en texto plano en producción.
...
export const PRODUCTS = [
  ...
  export const USERS = [
    // usuario demo (solo desarrollo)
    {
      ...
      // contraseña en texto para el mock: "password123"
      // En los siguientes scripts el login comparará tal cual (solo desarrollo)
      password: 'password123',
      createdAt: '2025-01-01T00:00:00.000Z'
    }
  ]
  
  // Exporta categorías útiles si quieres filtrar rápido:
  export const CATEGORIES = [...new Set(PRODUCTS.map(p => p.category))]
  
  // Conversaciones mock para el chat (vacío para empezar)
  export const CONVERSATIONS = [
    // ejemplo:
    // {
    //   id: 'c1',
    //   userId: 'u1',
    //   messages: [{ role: 'user', text: 'Hola' }, { role: 'assistant', text: 'Hola, ¿en qué te ayudo?' }],
